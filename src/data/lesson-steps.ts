...
export const LESSON_STEPS: LessonStep[][] = [
  ...
  [
    ...
    { text: '3. Tạo thư mục mới: Nhấp chuột phải vào một khoảng trống -> chọn New -> Folder. Đặt tên thư mục là ThucHanh_ToBaoNhi. Nhấn Enter.' },
    { text: '4. Vào thư mục vừa tạo: Nhấp đúp vào thư mục ThucHanh_ToBaoNhi.' },
    ...
    { text: '7. Tạo thư mục con: Trong thư mục ThucHanh_ToBaoNhi, nhấp chuột phải -> New -> Folder. Đặt tên là TaiLieu.' },
